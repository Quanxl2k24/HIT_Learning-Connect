...
import './AdminDocumentActionEdit.css'
import SideBar from '../../components/SideBar/SideBar'
function AdminDocumentActionEdit() {
  return (
            ...
            <div className="Home_Right">
                ...
                <div className="DocumentFormContainer">
                    ...
                    <form className="DocumentForm">
                        <div className="DocumentFormTitle">Chỉnh sửa tài liệu</div>
                        <label>
                            Tên tài liệu *
...
export default AdminDocumentActionEdit